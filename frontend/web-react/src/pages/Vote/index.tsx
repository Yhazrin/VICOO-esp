  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden border-2 border-warm-gray/20 bg-aged-stock mb-3 group-hover:border-rust/30 transition-colors duration-300">
        ...
        />
        {/* Vote button overlay */}
        <div className="absolute inset-0 z-20 flex items-end justify-center pb-4 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-300">
          <motion.button
