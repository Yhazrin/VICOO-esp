...
export default function DonateShowcase() {
      ...
      <SectionContainer>
        ...
        >
          <p className="font-body text-overline text-paper/50 tracking-[0.15em] uppercase mb-4">
            {t('donateClothing.showcaseTitle', 'Recrafted Product Showcase')}
          </p>
          <h2 className="font-display text-h2 text-paper mb-4">
            {t('donateClothing.showcaseSubtitle', 'Selected pieces revived from recycled garments, refreshed and ready for their next story.')}
          </h2>
          <p className="font-body text-body-sm text-paper/60 mb-8">
            {t('donateClothing.showcaseDescription', 'Each item carries a recycle badge and full supply chain traceability. Browse the circular shop to discover unique pieces.')}
          </p>
          <Link
            to="/impact/shop"
