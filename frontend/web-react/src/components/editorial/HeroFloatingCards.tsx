  ...
  return (
    <div className={`absolute right-0 top-0 bottom-0 w-[44%] z-[4] ${className}`} aria-hidden="true">
      ...
      <FloatingCard
        ...
        x="50px"
      >
        <div className="bg-[var(--color-aged-stock)] rounded-md border border-black/5 overflow-hidden flex flex-col shadow-lg shadow-black/5">
          <svg viewBox="0 0 130 130" width="100%" style={{ flex: 1 }} xmlns="http://www.w3.org/2000/svg">
            <rect x="10" y="10" width="110" height="110" fill="var(--color-paper)" rx="3"/>
            <circle cx="45" cy="50" r="18" fill="var(--color-rust)" opacity="0.5"/>
            <circle cx="78" cy="42" r="12" fill="var(--color-sepia-light)" opacity="0.7"/>
            <path d="M20 80 Q40 65 60 78 Q80 90 110 72" stroke="var(--color-accent)" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
            <path d="M25 95 Q55 85 85 95 Q100 100 115 90" stroke="var(--color-sepia-dark)" strokeWidth="1.8" fill="none" strokeLinecap="round"/>
            <rect x="15" y="105" width="40" height="8" rx="2" fill="var(--color-sepia-light)" opacity="0.5"/>
      ...
      >
        <div className="bg-[var(--color-aged-stock)] rounded-md border border-black/5 overflow-hidden flex flex-col shadow-lg shadow-black/5">
          <svg viewBox="0 0 110 120" width="100%" style={{ flex: 1 }} xmlns="http://www.w3.org/2000/svg">
            <rect x="8" y="8" width="94" height="104" fill="var(--color-aged-stock)" rx="3"/>
            <path d="M20 28 Q30 15 40 22 L55 18 L70 22 Q80 15 90 28" stroke="#888" strokeWidth="1.2" fill="none"/>
            <rect x="20" y="28" width="70" height="75" fill="var(--color-sepia-mid)" opacity="0.4" rx="2"/>
            <circle cx="42" cy="55" r="10" fill="var(--color-rust)" opacity="0.45"/>
            <path d="M35 68 Q55 60 72 70" stroke="var(--color-accent)" strokeWidth="2" fill="none" strokeLinecap="round"/>
            <rect x="28" y="80" width="15" height="15" rx="2" fill="var(--color-sepia-light)" opacity="0.6"/>
            <rect x="47" y="82" width="15" height="12" rx="2" fill="var(--color-muted-gray)" opacity="0.5"/>
      ...
      <FloatingCard
        ...
        x="50px"
      >
        <div className="bg-[var(--color-paper)] rounded-md border border-black/5 overflow-hidden flex flex-col shadow-lg shadow-black/5">
          <svg viewBox="0 0 145 140" width="100%" style={{ flex: 1 }} xmlns="http://www.w3.org/2000/svg">
            <rect x="8" y="8" width="129" height="124" fill="var(--color-paper)" rx="3"/>
            <path d="M25 45 Q40 20 72 30 Q104 20 120 45" stroke="var(--color-rust)" strokeWidth="1.5" fill="none" opacity="0.5"/>
            <ellipse cx="72" cy="65" rx="22" ry="14" fill="var(--color-sepia-light)" opacity="0.55"/>
            <path d="M30 85 Q55 74 80 82 Q100 88 120 78" stroke="var(--color-accent)" strokeWidth="2.2" fill="none" strokeLinecap="round"/>
            <path d="M40 98 Q65 90 90 100 Q108 106 125 96" stroke="var(--color-sepia-dark)" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
            <circle cx="35" cy="55" r="7" fill="var(--color-rust)" opacity="0.3"/>
            <circle cx="110" cy="52" r="5" fill="var(--color-accent)" opacity="0.4"/>
      ...
      >
        <div className="bg-[var(--color-aged-stock)] rounded-md border border-black/5 overflow-hidden flex flex-col shadow-lg shadow-black/5">
          <svg viewBox="0 0 105 108" width="100%" style={{ flex: 1 }} xmlns="http://www.w3.org/2000/svg">
            <rect x="8" y="8" width="89" height="92" fill="var(--color-aged-stock)" rx="3"/>
            <path d="M20 35 Q52 20 85 35 L82 90 L23 90 Z" fill="var(--color-warm-gray)" opacity="0.35"/>
            <circle cx="52" cy="52" r="14" fill="none" stroke="var(--color-rust)" strokeWidth="1.5" opacity="0.5"/>
            <circle cx="52" cy="52" r="6" fill="var(--color-rust)" opacity="0.4"/>
            <path d="M25 72 Q52 62 80 72" stroke="var(--color-accent)" strokeWidth="1.8" fill="none" strokeLinecap="round"/>
