...
const morandiPlugin = function ({ addUtilities, addBase, theme }) {
  ...
  addBase({
    ...
    '[data-theme="dark-pink"]': {
      '--mor-bg': '#1A1A1D',
      '--mor-bg-elevated': '#242428',
      '--mor-bg-subtle': '#1E1E22',
      '--mor-bg-muted': '#2A2A30',
      '--mor-panel': '#242428',
      '--mor-panel-2': '#2E2E34',
      '--mor-panel-3': '#38383E',
      '--mor-panel-inset': '#202024',
      '--mor-text': '#F0ECE8',
      '--mor-text-muted': '#9A969C',
      '--mor-text-subtle': '#6A666C',
      '--mor-text-disabled': '#4A4650',
      '--mor-text-inverse': '#1A1A1D',
      '--mor-border': '#3A3A44',
      '--mor-border-strong': '#55555E',
      '--mor-border-subtle': '#2E2E36',
      '--mor-border-muted': '#242430',
      '--mor-primary': '#E6397C',
      '--mor-primary-hover': '#FF5090',
      '--mor-primary-active': '#C42060',
      '--mor-primary-muted': '#5A2040',
      '--mor-primary-subtle': '#301828',
      '--mor-accent': '#FF6BA0',
      '--mor-accent-hover': '#FF85B0',
      '--mor-accent-muted': '#803050',
      '--mor-success': '#5CBD5C',
      '--mor-success-bg': '#1A2E1A',
      '--mor-success-muted': '#3A6A3A',
      '--mor-warning': '#D4AA5A',
      '--mor-warning-bg': '#2E2818',
      '--mor-warning-muted': '#8A7040',
      '--mor-danger': '#E6397C',
      '--mor-danger-bg': '#2E1820',
      '--mor-danger-muted': '#8A3050',
      '--mor-info': '#7A9AB8',
      '--mor-info-bg': '#1A2430',
      '--mor-info-muted': '#4A6478',
      '--mor-chart-1': '#E6397C',
      '--mor-chart-2': '#FF6BA0',
      '--mor-chart-3': '#9A5090',
      '--mor-chart-4': '#6A80C0',
